...
def generate_tts():
    try:
        ...
        # Map Neil to the closest free Edge TTS voice
        voice_mapping = {
            'Neil': 'en-US-GuyNeural',  # Closest male voice to Neil
            'Neil-Female': 'en-US-JennyNeural',  # Alternative female voice
            'Neil-UK': 'en-GB-RyanNeural'  # UK male voice option
        }
        
        # If Neil is selected, use the mapped voice
...
def stream_tts():
    try:
        ...
        # Map Neil to closest free voice
        voice_mapping = {
            'Neil': 'en-US-GuyNeural',
            'Neil-Female': 'en-US-JennyNeural',
            'Neil-UK': 'en-GB-RyanNeural'
        }
        if voice in voice_mapping:
            voice = voice_mapping[voice]
